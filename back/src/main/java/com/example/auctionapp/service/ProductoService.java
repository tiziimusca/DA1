...
public class ProductoService {
    ...
    public ProductoDTO actualizarProducto(Integer id, ProductoDTO productoDto, String authorizationHeader) {
        obtenerUsuarioDesdeToken(authorizationHeader);
    ...
    public Map<String, Object> obtenerSeguimientoDTO(Integer productoId, String authorizationHeader) {
        ...
        responseDto.put("fechaEnviado",
                productoDetalle.getFechaEnviado() != null ? productoDetalle.getFechaEnviado().format(formatter) : null);
        responseDto.put("fechaRevision",
                productoDetalle.getFechaRevision() != null ? productoDetalle.getFechaRevision().format(formatter)
                        : null);
        responseDto.put("fechaInspeccionTecnica",
                productoDetalle.getFechaInspeccionTecnica() != null
                        ? productoDetalle.getFechaInspeccionTecnica().format(formatter)
                        : null);
        responseDto.put("fechaAceptado",
                productoDetalle.getFechaAceptado() != null ? productoDetalle.getFechaAceptado().format(formatter)
                        : null);
        responseDto.put("fechaRechazado",
                productoDetalle.getFechaRechazado() != null ? productoDetalle.getFechaRechazado().format(formatter)
                        : null);
    ...
    public Map<String, Object> devolverProducto(Integer productoId, String opcion, String authorizationHeader) {
        ...
        if ("enviado".equalsIgnoreCase(estadoActual) || "revision".equalsIgnoreCase(estadoActual)
                || "en_revision".equalsIgnoreCase(estadoActual)) {
    ...
    private byte[] compressImage(byte[] imageBytes) {
        ...
        try {
            ...
            java.awt.Image resultingImage = originalImage.getScaledInstance(newWidth, newHeight,
